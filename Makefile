...
ENTREGAR = fecha libro socio prestamo lseSocios ldePrestamos abbLibros reserva colaReservas agGeneros conjuntoGeneros biblioteca colaDePrioridadReservas tablaReserva
...
# casos de prueba
IDS_PUBLICOS = colaPrioridadReservas1-crear-esVacia-liberar \
